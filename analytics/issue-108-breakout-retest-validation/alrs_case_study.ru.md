# Задача #108: кейс ALRS 2026-08-20
...
Вето #97 остаётся верным, если state machine не подтвердила пробой 19.94. Role reversal — не основание покупать 19.80 внутри активной импульсной зоны.
