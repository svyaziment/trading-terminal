...
Последнее обновление: 2026-09-08 (в §35 зафиксировано решение Product Owner: `ultra_late_tight` — сетка из решётки `143-trailing-v3`, допоставленной задачей #155, — становится боевым дефолтом сетки трейлинг-стопа для #144; `enabled` остаётся `false`). Сопутствующий файл: `project-context.ru.md` (английский оригинал: `project-context.md`).
