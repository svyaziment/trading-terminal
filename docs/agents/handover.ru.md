...
- **Решение Product Owner от 2026-09-08: боевой дефолт сетки — `ultra_late_tight`.**
  ...
  (+7 218 ₽), PF 1.60 против 1.55, 3 162 сделки против 3 118, худшее walk-forward окно +1 366 ₽ против
  +745 ₽, лучший худший узел стресс-решётки издержек (19 364 ₽ против 16 708 ₽ при комиссии 0.15 % и
  проскальзывании 20 б.п.) и минимальный поведенческий дифф среди лестниц (141 смена причины выхода =
  4.3 %, ρ Спирмена 0.9966). Принятый компромисс: сводный балл устойчивости 46.3 против 47.3 у `ref139` и
