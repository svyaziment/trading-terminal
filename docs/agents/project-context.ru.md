...
- Почему выиграла именно она: лучший капитал решётки — 110 434 ₽ (+7 218 к `ref139`, +1 865 к лучшей лестнице),
  PF 1.60, 3 162 сделки, win rate 42.6 %, худшее walk-forward окно +1 366 ₽ против +745 ₽ у базовой сетки, лучший
  худший узел в стрессе издержек (19 364 ₽ при комиссии 0.15 % и проскальзывании 20 б.п.) и минимальный
  поведенческий дифф среди лестниц (141 смена причины выхода против базы = 4.3 %, ρ Спирмена 0.9966): прирост дала
...
- Чем заплатили: сводный балл устойчивости 46.3 против 47.3 у `ref139` и daily MaxDD 3.06 против 2.72 п.п. Балл —
  ...
  капитала, пола walk-forward и худшего узла в стрессе признан дороже +0.34 п.п. просадки.
